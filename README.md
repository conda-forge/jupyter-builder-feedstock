About jupyter-builder-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-builder-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-builder-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-builder jupyter-builder-with-nodejs
# for installing globally
pixi global install jupyter-builder jupyter-builder-with-nodejs
```
...
It is possible to list all of the versions of `jupyter-builder` available on your platform:
...
```
pixi search jupyter-builder --channel conda-forge
```
...
Updating jupyter-builder-feedstock
==================================

If you would like to improve the jupyter-builder recipe or build a new
...
Note that all branches in the conda-forge/jupyter-builder-feedstock are
